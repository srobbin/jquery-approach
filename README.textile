...
Note: This demo only works in browsers that support the CSS style, opacity (not older versions of IE). I will update to a more cross-browser-friendly version soon.
